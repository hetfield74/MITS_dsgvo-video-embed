...
class mits_dsgvo_video_embed{
    ...
    function __construct(){
        ...
        $this->title = MODULE_MITS_DSGVO_VIDEO_EMBED_TITLE;
        $this->description = MODULE_MITS_DSGVO_VIDEO_EMBED_DESCRIPTION;
        $this->sort_order = MODULE_MITS_DSGVO_VIDEO_EMBED_SORT_ORDER;
        $this->enabled = ((MODULE_MITS_DSGVO_VIDEO_EMBED_STATUS == 'true') ? true : false);
    }
