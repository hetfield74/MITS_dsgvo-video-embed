...
define('MODULE_MITS_DSGVO_VIDEO_EMBED_TEXT_DESCRIPTION', '
    ...
    <br /><br />
    <div style="border:1px solid #666;background:#ffc;padding:3px"><strong>Rechtlicher Hinweis / Disclaimer</strong><br />
    ...
    <br /><br /><strong>Der Gebrauch erfolgt auf eigenes Risiko!</strong></i></div>
');
